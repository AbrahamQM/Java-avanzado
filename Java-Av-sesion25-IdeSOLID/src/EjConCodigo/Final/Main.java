...
public class Main {
    public static void main(String []args) {
        ...
        //Aquí utilizaremos las estadísticas
        imprimirEstadisticas(usuariosDB);
    }

    //Aqui creamos la funcion imprimirEstadisticas();
    public static void imprimirEstadisticas(UsuariosDB usuariosDB) {
        System.out.println("Inserciones: " + ((UsuariosDBEstadisticas)(usuariosDB)).getTotalInserciones());
        System.out.println("Eliminaciones: " + ((UsuariosDBEstadisticas)(usuariosDB)).getTotalEliminaciones());
    }
